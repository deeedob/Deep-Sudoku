/*!
 * @ingroup PROC
 * @brief Converting QImages to cv::Mat
 * @author Debao Zhang
 */
#pragma once
 ...
 */
	cv::Mat image2MatShared( const QImage& img, MatColorOrder* order = nullptr );
	QImage mat2ImageShared( const cv::Mat& mat, QImage::Format formatHint = QImage::Format_Invalid );
